      ...
      <div className="min-h-screen z-40 grid grid-cols-2 bg-[#d6a231]">
        ...
        <div className="flex flex-col justify-center items-center">
          <div className="flex flex-col w-[33vw]">
            <h1 className="font-bold text-3xl font-sans">Create Your LinkTree</h1>
            ...
            <div className="flex flex-col gap-2 mt-5">
              ...
              <input
                value={handle}
                onChange={(e) => sethandle(e.target.value)}
                className="bg-white rounded-[9px] w-[29vw] h-9 pl-3"
                type="text"
                placeholder="Choose a Handle"
              />
            </div>
            ...
            <div className="flex flex-col gap-2 mt-5">
              ...
              {Links.map((item, index) => (
                <div key={index} className="flex flex-row gap-3">
                  <input
                    ...
                    className="bg-white rounded-[9px] w-full h-9 pl-3"
                    type="text"
                    placeholder="Enter link text"
                  />
                  <input
              ...
              <button
                onClick={addLinks}
                className="text-white bg-black font-medium w-[15vw] rounded-[9px] ml-[10vw] h-8 hover:cursor-pointer"
              >
                + Add link
              </button>
            </div>
            ...
            <div className="flex flex-col gap-2 mt-5">
              ...
              <div className="flex flex-row gap-3">
                <input
                  value={pic}
                  onChange={(e) => setpic(e.target.value)}
                  className="bg-white rounded-[9px] w-[54vw] h-9 pl-3"
                  type="text"
                  placeholder="Enter link to your picture"
                />
                <button
                  disabled={
                    !pic || !handle || Links.some((l) => !l.linktext || !l.link)
                  }
                  onClick={() => submitLinks(Links, handle)}
                  className="disabled:bg-slate-800 text-white bg-black font-medium w-[12vw] rounded-[9px] h-8 hover:cursor-pointer"
                >
                  Create
                </button>
              </div>
